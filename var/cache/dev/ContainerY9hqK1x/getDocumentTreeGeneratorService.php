...
class getDocumentTreeGeneratorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['Pimcore\\Sitemap\\Document\\DocumentTreeGenerator'] = new \Pimcore\Sitemap\Document\DocumentTreeGenerator(new \Pimcore\Sitemap\Document\DocumentUrlGenerator(($container->privates['Pimcore\\Sitemap\\UrlGenerator'] ?? $container->load('getUrlGeneratorService'))), [0 => new \Pimcore\Sitemap\Element\Filter\PublishedFilter(), 1 => new \Pimcore\Sitemap\Element\Filter\PropertiesFilter(), 2 => new \Pimcore\Sitemap\Document\Filter\DocumentTypeFilter(), 3 => new \Pimcore\Sitemap\Document\Filter\SiteRootFilter()], [0 => new \Pimcore\Sitemap\Element\Processor\ModificationDateProcessor(), 1 => new \Pimcore\Sitemap\Element\Processor\PropertiesProcessor()]);
    }
}
