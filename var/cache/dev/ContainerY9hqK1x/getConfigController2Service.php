...
class getConfigController2Service extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Pimcore\\Bundle\\EcommerceFrameworkBundle\\Controller\\ConfigController'] = $instance = new \Pimcore\Bundle\EcommerceFrameworkBundle\Controller\ConfigController(($container->services['router'] ?? $container->getRouterService()));

        $instance->setContainer(($container->privates['.service_locator.oafe0zm'] ?? $container->load('get_ServiceLocator_Oafe0zmService'))->withContext('Pimcore\\Bundle\\EcommerceFrameworkBundle\\Controller\\ConfigController', $container));
