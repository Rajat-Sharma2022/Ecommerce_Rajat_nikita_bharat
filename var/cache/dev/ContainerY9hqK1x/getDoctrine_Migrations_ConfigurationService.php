...
class getDoctrine_Migrations_ConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addMigrationsDirectory('CustomerManagementFrameworkBundle\\Migrations\\PimcoreX', (\dirname(__DIR__, 4).'/vendor/pimcore/customer-management-framework-bundle/src/Migrations/PimcoreX'));
        $instance->addMigrationsDirectory('Web2PrintToolsBundle\\Migrations\\PimcoreX', (\dirname(__DIR__, 4).'/vendor/pimcore/web2print-tools-bundle/src/Migrations/PimcoreX'));
