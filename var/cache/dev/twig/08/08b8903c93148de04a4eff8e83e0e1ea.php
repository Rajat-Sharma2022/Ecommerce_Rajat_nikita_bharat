...
class __TwigTemplate_da22c16e69d041b6b82e30cf3e550528 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_hwi_oauth_content($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    <h3>";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("header.registration_success", ["%username%" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 4, $this->source); })()), "user", [], "any", false, false, true, 4), "username", [], "any", false, false, true, 4)], "HWIOAuthBundle"), "html", null, true);
        echo "</h3>
";
...
", "@HWIOAuth/Connect/registration_success.html.twig", "/var/www/html/EcommerceProject/ecom/vendor/hwi/oauth-bundle/Resources/views/Connect/registration_success.html.twig");
    }
