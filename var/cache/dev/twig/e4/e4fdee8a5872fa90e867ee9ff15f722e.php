...
class __TwigTemplate_8fead75a5df0f795a4a12550e6987efe extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    events: [ ";
            // line 161
            echo twig_call_macro($macros["__internal_parse_4"], "macro_dump_events", [(isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 161, $this->source); })())], 161, $context, $this->getSourceContext());
            echo " ],
}
";
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "/var/www/html/EcommerceProject/ecom/vendor/symfony/web-profiler-bundle/Resources/views/Collector/time.html.twig");
    }
