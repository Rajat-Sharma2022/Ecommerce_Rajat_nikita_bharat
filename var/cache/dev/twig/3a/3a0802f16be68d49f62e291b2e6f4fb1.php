...
/* @PimcoreEcommerceFramework/admin_order/item_complaint.html.twig */
class __TwigTemplate_8eefeedaee6213226d945742249b3492 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@PimcoreEcommerceFramework/admin_order/item_complaint.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@PimcoreEcommerceFramework/admin_order/item_complaint.html.twig"));
...
<form action=\"";
    ...
    <div class=\"modal-header\">
        ...
        echo " <small>";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("bundle_ecommerce.back-office.order.item-complaint", [], "admin"), "html", null, true);
        echo "</small></h5>
    ...
    <div class=\"modal-body\">
        ...
        // line 23
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("bundle_ecommerce.back-office.order.item-complaint.message", [], "admin"), "html", null, true);
        echo "</label>
...
";
    ...
    {
        return "@PimcoreEcommerceFramework/admin_order/item_complaint.html.twig";
    }
...
<form action=\"{{ urlSave }}\" method=\"post\">
    ...
    <div class=\"modal-header\">
        <h5 class=\"modal-title\">{{ orderItem.getProductName() }} <small>{{ ('bundle_ecommerce.back-office.order.item-complaint')|trans([],'admin') }}</small></h5>
        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">
            <span aria-hidden=\"true\">&times;</span>
        </button>
    </div>
    <div class=\"modal-body\">
        ...
        <div class=\"row form-group\">
            <label class=\"col-sm-12\" for=\"message\">{{ ('bundle_ecommerce.back-office.order.item-complaint.message')|trans([],'admin') }}</label>
            <div class=\"col-sm-12\"><textarea class=\"form-control\" name=\"message\" id=\"message\" rows=\"6\"></textarea></div>
        </div>

    </div>
    <div class=\"modal-footer\">
        <button type=\"submit\" class=\"btn btn-primary\" name=\"confirmed\" value=\"1\">{{ ('bundle_ecommerce.back-office.order.item-complaint')|trans([],'admin') }}</button>
    </div>
</form>
", "@PimcoreEcommerceFramework/admin_order/item_complaint.html.twig", "/var/www/html/EcommerceProject/ecom/vendor/pimcore/pimcore/bundles/EcommerceFrameworkBundle/Resources/views/admin_order/item_complaint.html.twig");
    }
