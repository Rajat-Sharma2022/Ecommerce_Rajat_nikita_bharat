...
class __TwigTemplate_b34732bb86072127ebba14f33361229f extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 210, $this->source); })()), "data", [], "any", false, false, true, 210), "forms", [], "any", false, false, true, 210))) {
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 214
                echo "                ";
                echo twig_call_macro($macros["__internal_parse_3"], "macro_form_tree_entry", [$context["formName"], $context["formData"], true], 214, $context, $this->getSourceContext());
                echo "
            ";
            }
...
{% macro form_tree_details(name, data, forms_by_hash, show) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/form.html.twig", "/var/www/html/EcommerceProject/ecom/vendor/symfony/web-profiler-bundle/Resources/views/Collector/form.html.twig");
    }
