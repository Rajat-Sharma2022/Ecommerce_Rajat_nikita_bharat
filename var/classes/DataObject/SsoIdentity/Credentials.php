...
*/
public function getOAuth1Token(bool $includeDeletedBricks = false)
{
	if(!$includeDeletedBricks &&
		isset($this->OAuth1Token) &&
		$this->OAuth1Token->getDoDelete()) {
			return null;
	}
...
*/
public function getOAuth2Token(bool $includeDeletedBricks = false)
{
	if(!$includeDeletedBricks &&
		isset($this->OAuth2Token) &&
		$this->OAuth2Token->getDoDelete()) {
			return null;
	}
